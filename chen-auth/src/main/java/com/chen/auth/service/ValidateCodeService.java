...
import com.chen.auth.properties.ValidateCodeProperties;
...
public class ValidateCodeService {
    ...
    private Captcha createCaptcha(ValidateCodeProperties code) {
        ...
        if (StringUtils.equalsIgnoreCase(code.getType(), SystemConstant.GIF)) {
    ...
    private void setHeader(HttpServletResponse response, String type) {
        if (StringUtils.equalsIgnoreCase(type, SystemConstant.GIF)) {
