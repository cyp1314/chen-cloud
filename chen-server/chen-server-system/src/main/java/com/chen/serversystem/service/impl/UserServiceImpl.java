...
import com.chen.common.entity.CurrentUser;
...
import com.chen.serversystem.mapper.UserMapper;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, SystemUser> implements IUserService {
    ...
    @Override
    @Transactional(rollbackFor = Exception.class)
    public void updateProfile(SystemUser user) throws SystemException {
        user.setPassword(null);
        user.setUsername(null);
        user.setStatus(null);
    ...
    public void updateAvatar(String avatar) {
        ...
        String currentUsername = SystemUtil.getCurrentUsername();
    ...
    private boolean isCurrentUser(Long id) {
        CurrentUser currentUser = SystemUtil.getCurrentUser();
