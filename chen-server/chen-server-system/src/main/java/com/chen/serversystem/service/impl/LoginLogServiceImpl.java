...
import com.chen.common.entity.db.system.LoginLog;
import com.chen.common.entity.db.system.SystemUser;
import com.chen.common.utils.QueryRequest;
import com.chen.common.utils.SortUtil;
import com.chen.common.utils.SystemUtil;
import com.chen.serversystem.mapper.LoginLogMapper;
import com.chen.serversystem.service.ILoginLogService;
import com.chen.serversystem.util.AddressUtil;
...
public class LoginLogServiceImpl extends ServiceImpl<LoginLogMapper, LoginLog> implements ILoginLogService {
    ...
    public IPage<LoginLog> findLoginLogs(LoginLog loginLog, QueryRequest request) {
        ...
        SortUtil.handlePageSort(request, page, "loginTime", SystemConstant.ORDER_DESC, true);
    ...
    public void saveLoginLog(LoginLog loginLog) {
        ...
        String ip = SystemUtil.getHttpServletRequestIpAddress();
        loginLog.setIp(ip);
